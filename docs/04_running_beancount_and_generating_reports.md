...
At the moment, in order to access reports from these subsets of
...
1.  compute the balances of the Income and Expenses account at that
    point in time,
...
The difference between the total of Income and Expenses balances is the
Net Income.
