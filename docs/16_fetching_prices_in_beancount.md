...
Finally, while we provide some basic implementations of price sources,
...
If you are using an input file to specify the list of prices to be
...
3.  **Converted commodities.** Prices for holdings which were
