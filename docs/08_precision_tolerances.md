...
Note that if a tolerance could be inferred from other numbers on that
...
-   "Tolerances" are values used to determine how much imprecision is
...
> PRINT command does not attempt to render using the DisplayContext
